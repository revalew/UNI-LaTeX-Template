...
%---------------------------------------------------------------------------
%           ADD NICE CODE FRAGMENTS
%---------------------------------------------------------------------------
\begin{lstlisting}[language=Python, style=allSettingsStyle, caption={Fragment kody tworzący prymityw \textbf{Sphere}}, label={code: primitive sphere}, numbers=none]
    AttributeBegin
...
\lstinputlisting[language=Python, style=allSettingsStyle, caption={Fragment otrzymanej kalibracji dla metody \textbf{findChessboardCorners()}}, label={code: findChessboardCorners calibration}, frame=single, breaklines=true, breakatwhitespace=true, basicstyle=\fontsize{10}{5}\selectfont\ttfamily]{../src/code/findChessboardCorners.json}
...
%---------------------------------------------------------------------------
%           SIMPLE TABLE WITH MULTI-ROW CELLS
%---------------------------------------------------------------------------

\newcommand{\subjectWeekDay}{Czwartek,}
\newcommand{\subjectHours}{10:00-13:15}
...
\begin{table}[H]
    ...
    \makebox[1\linewidth][c]{
        ...
        \hline
        \multicolumn{6}{|p{20cm}|}{\centering \vspace{.3cm}\empty
        
        \fontsize{22}{10}\selectfont\textbf{\subjectName}
        
        } \\ \hline
        % \multicolumn{1}{|p{3cm}|}{\centering 2024/2025} & \multirow{2}{*}{Termin} & \multicolumn{1}{|p{3cm}|}{\centering Rodzaj studiów} & \multicolumn{1}{|p{3cm}|}{\centering Kierunek} & \multicolumn{1}{|p{3cm}|}{\centering Prowadzący} & \multicolumn{1}{|p{3cm}|}{\centering Grupa} \\ \hline

        \multicolumn{1}{|p{3cm}|}{\centering Rok akademicki} & \multicolumn{1}{p{2.5cm}|}{\centering Termin} & \multicolumn{1}{p{3cm}|}{\centering Rodzaj studiów} & \multicolumn{1}{|p{2cm}|}{\centering Kierunek} & \multicolumn{1}{p{6cm}|}{\centering Prowadzący} & \multicolumn{1}{c|}{\centering Grupa} \\ \hline

        \multirow{2}{*}{\centering 2024/2025} & \multicolumn{1}{p{2.5cm}|}{\centering \subjectWeekDay
        
        \subjectHours} & \multirow{2}{*}{Stacjonarne} & \multirow{2}{*}{Informatyka} & \multicolumn{1}{p{6cm}|}{\centering\vspace*{-.5cm}\lecturerOne
        
        \vspace*{-.1cm}\lecturerTwo} & \multirow{2}{*}{IGT} \\ \hline
